...
user_list = user_list if user_list else from_file_get_data(r'D:\project_practice\pyhon_01_PRACTICE\homework\user_data.txt')
...
class User():
    # 构造方法
    def __init__(self):
        global login_status  # 构造一个全局变量,登录状态
        self.result = result
